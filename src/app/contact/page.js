...
export default function ContactPage() {
  ...
  const validateForm = (formData) => {
    ...
    if (!phone) {
      ...
      errors.phone = 'Enter valid Indian mobile number (10 digits starting with 6-9)';
    }
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 font-inter max-w-3xl mx-auto">
              Get in touch with us to discuss your project. We typically respond within 24 hours.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Contact Info */}
            <div>
              <h2 className="text-3xl font-bold mb-8 font-poppins text-gray-900">Contact Information</h2>
              
              <div className="space-y-6 mb-8">
                <div className="flex items-start gap-4 bg-white p-6 rounded-xl shadow-md">
                  <span className="text-4xl">💬</span>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2 font-poppins">WhatsApp</h3>
                    <a 
                      href="https://wa.me/919281040446" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-blue-600 hover:text-blue-700 font-inter text-lg"
                    >
                      +91-9281040446
                    </a>
                ...
                <div className="flex items-start gap-4 bg-white p-6 rounded-xl shadow-md">
                  <span className="text-4xl">📧</span>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2 font-poppins">Email</h3>
                    <a 
                ...
                <div className="flex items-start gap-4 bg-white p-6 rounded-xl shadow-md">
                  <span className="text-4xl">📍</span>
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2 font-poppins">Location</h3>
                    <p className="text-gray-700 font-inter">Hyderabad, Telangana, India</p>
                    <p className="text-gray-600 text-sm mt-1">Serving clients across India</p>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-br from-slate-900 to-gray-900 text-white rounded-xl p-8">
                <h3 className="text-2xl font-bold mb-4 font-poppins">Why Choose Us?</h3>
            ...
            <div>
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h2 className="text-2xl font-bold mb-6 font-poppins text-gray-900">Quick Contact Form</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Website + Engagement">Website + Engagement</option>
