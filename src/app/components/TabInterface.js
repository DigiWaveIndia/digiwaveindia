...
export default function TabInterface() {
  ...
  const ContactSection = () => (
    <div className="mt-12 md:mt-16 pt-6 md:pt-8 border-t border-gray-200">
      <h2 className="text-3xl font-bold text-center mb-6 md:mb-8 font-poppins text-gray-800">Contact Us</h2>
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-4xl mx-auto">
        <div>
          <h3 className="text-xl font-semibold mb-4 font-poppins text-gray-800">Get in Touch</h3>
          <div className="space-y-3">
            <div className="flex items-center">
              <span className="text-xl mr-3">📧</span>
              <a href="mailto:support@digiwaveindia.com" className="text-blue-600 hover:underline font-inter">support@digiwaveindia.com</a>
            </div>
            <div className="flex items-center">
              <span className="text-xl mr-3">📞</span>
            ...
            <div className="flex items-center">
              <span className="text-xl mr-3">🌐</span>
              <span className="font-inter text-gray-800">Based in India | Serving Clients Worldwide</span>
            </div>
          </div>
        </div>
        <div>
          <h3 className="text-xl font-semibold mb-4 font-poppins text-gray-800">Send Us a Message</h3>
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 bg-white shadow-sm z-50">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="text-2xl font-bold text-blue-600 font-poppins text-center mb-4">DigiWave India</div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        {activeTab === 'home' && (
          <div>
            ...
            {/* Why Choose DigiWave */}
            <section className="mb-12 md:mb-16">
              <h2 className="text-3xl font-bold text-center mb-8 font-poppins text-gray-800">Why Choose DigiWave</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center">
                  <div className="text-3xl mb-3">⚡</div>
                  <h3 className="text-lg font-semibold mb-2 font-poppins text-gray-800">Fast Delivery</h3>
                  <p className="text-gray-700 font-inter text-sm">Quick turnaround times without compromising quality.</p>
                </div>
                <div className="text-center">
                  <div className="text-3xl mb-3">💡</div>
                  <h3 className="text-lg font-semibold mb-2 font-poppins text-gray-800">Modern Design</h3>
                  <p className="text-gray-700 font-inter text-sm">Contemporary designs that engage your users.</p>
                </div>
                <div className="text-center">
                  <div className="text-3xl mb-3">🤝</div>
                  <h3 className="text-lg font-semibold mb-2 font-poppins text-gray-800">Long-Term Support</h3>
                  <p className="text-gray-700 font-inter text-sm">We&apos;re here for you even after launch.</p>
                </div>
                <div className="text-center">
                  <div className="text-3xl mb-3">💰</div>
                  <h3 className="text-lg font-semibold mb-2 font-poppins text-gray-800">Transparent Pricing</h3>
                  <p className="text-gray-700 font-inter text-sm">No hidden costs, clear pricing structure.</p>
                </div>
              </div>
            </section>
        ...
        {activeTab === 'about' && (
          <div>
            <section>
              <h2 className="text-4xl font-bold mb-6 md:mb-8 font-poppins text-gray-800 text-center">About DigiWave India</h2>
        ...
        {activeTab === 'services' && (
          <div>
            <section>
              <h2 className="text-4xl font-bold text-center mb-8 md:mb-12 font-poppins text-gray-800">Our Services</h2>
