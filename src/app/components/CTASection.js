      ...
      <div className="relative max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl text-blue-100 font-inter max-w-3xl mx-auto">
            Whether you're just starting or ready to scale, DigiWave India has a solution built for you.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div className="grid md:grid-cols-2">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-8 md:p-10 text-white">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:support@digiwaveindia.com" className="text-white hover:text-blue-300 font-inter text-lg">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+919281040446" className="text-white font-inter text-lg">
                        +91-9281040446
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white font-inter">Based in India | Serving Clients Worldwide</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-10 pt-8 border-t border-gray-700">
                  <p className="text-gray-400 font-inter">
                    We typically respond within 24 hours. Let's discuss how we can help your business grow digitally.
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 md:p-10">
                <h3 className="text-2xl font-bold mb-6 font-poppins text-gray-900">Send Us a Message</h3>
