  ...
  return (
    <div className="relative h-64 flex items-center justify-center gap-6">
      ...
      <div className="relative z-10">
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-3xl p-1.5 shadow-xl border-2 border-green-400" style={{width: '110px'}}>
          ...
          <div className="bg-white rounded-2xl overflow-hidden" style={{height: '220px'}}>
        ...
        <div className="text-center mt-2">
          <div className="inline-flex items-center gap-1 bg-green-100 px-2 py-1 rounded-full">
            <span className="text-green-600 font-semibold text-xs">Android</span>
          </div>
        </div>
      </div>
      ...
      {/* iOS Phone */}
      <div className="relative z-10">
        <div className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-3xl p-1.5 shadow-xl border-2 border-gray-600" style={{width: '110px'}}>
