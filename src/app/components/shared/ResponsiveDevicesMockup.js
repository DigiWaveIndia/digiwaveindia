  ...
  return (
    <div className="relative h-64 flex items-center justify-center">
      ...
      <div className="absolute right-0 top-8 z-20 transform rotate-3">
        <div
          className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-1.5 shadow-lg border-2 border-blue-400"
          style={{ width: '140px' }}
        >
          <div
            className="bg-white rounded-lg overflow-hidden"
      ...
      <div className="absolute left-0 top-12 z-30 transform -rotate-3">
        <div
          className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-1.5 shadow-lg border-2 border-green-400"
          style={{ width: '90px' }}
        >
