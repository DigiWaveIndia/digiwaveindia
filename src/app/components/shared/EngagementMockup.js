export default function EngagementMockup() {
  return (
    <div className="relative h-64 flex items-center justify-center gap-4">
      {/* Admin Dashboard */}
      <div
        className="relative z-10 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl p-1.5 shadow-xl border-2 border-indigo-400"
        style={{ width: '200px' }}
      >
        <div
      ...
      {/* WhatsApp Automation */}
      <div
        className="relative z-20 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-1.5 shadow-xl border-2 border-green-400"
        style={{ width: '140px' }}
      >
        <div
