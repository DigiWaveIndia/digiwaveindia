        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 font-inter max-w-3xl mx-auto">
              Empowering India's small businesses through modern, affordable
              digital solutions
            </p>
          </div>
          ...
          <div className="mb-16">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 md:p-12">
              <h2 className="text-3xl font-bold mb-6 font-poppins text-gray-900">
                Who We Are
              </h2>
              <p className="text-lg text-gray-700 font-inter leading-relaxed">
                DigiWave India is a digital transformation partner for small
                businesses. We build websites, apps, automation systems, and
                dashboards that help local businesses grow in the digital world.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-cyan-500">
              ...
              <p className="text-gray-700 font-inter leading-relaxed">
                To make digital technology simple, accessible, and affordable
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-t-4 border-purple-500">
              ...
              <p className="text-gray-700 font-inter leading-relaxed">
                An India where every shop, clinic, coaching center, and service
                provider uses digital tools to grow their business.
              </p>
            </div>
          </div>
          ...
          <div className="mb-16">
            <div className="bg-gradient-to-br from-slate-900 to-gray-900 text-white rounded-2xl p-8 md:p-12">
              <h2 className="text-3xl font-bold mb-6 font-poppins">
                Why DigiWave India Was Started
              </h2>
              <p className="text-lg text-gray-300 font-inter leading-relaxed mb-6">
                We noticed that small businesses were being overcharged, misled,
                or given poor-quality websites.
              </p>
          ...
          <div className="mb-16">
              ...
              {[
                {
                  ...
                  desc: 'Website/app development costs too much',
                },
                {
                  icon: '🔄',
                  title: 'Difficulty Retaining Customers',
                  desc: 'No system to bring customers back',
                },
                {
                  icon: '📊',
                  title: 'No Business Visibility',
                  desc: 'No insights into business performance',
                },
                {
                  icon: '📅',
                  title: 'Manual Management',
                  desc: 'Manual appointment and booking management',
                },
                {
                  icon: '⚙️',
                  title: 'Lack of Automation',
                  desc: 'Everything done manually',
                },
              ].map((item, idx) => (
                <div
                  key={idx}
            ...
            <div className="text-center mt-8">
              <p className="text-2xl font-bold text-cyan-600 font-poppins">
                Our dashboard + automation solves this.
              </p>
            </div>
          </div>
